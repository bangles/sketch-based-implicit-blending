...
namespace Eigen{
    ...
    public:
        ...
        template <typename Derived1, typename Derived2>
        void closest_point( const MatrixBase<Derived1>& queries, MatrixBase<Derived2>& footpoints ){
        ...
        void closest_point( const MatrixBase<Derived1>& queries, MatrixBase<Derived2>& footpoints, MatrixBase<Derived3>& indexes ){
            for(int iq=0; iq<queries.cols(); iq++){
                Point_3 query = tr(queries.col(iq));
        ...
        template <typename Derived1, typename Derived2, typename Derived3>
        void barycentric( const MatrixBase<Derived1>& footpoints, const MatrixBase<Derived2>& indexes, MatrixBase<Derived3>& coordinates ){
            Matrix<FT, 3,3> A;
