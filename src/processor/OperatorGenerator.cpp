...
OperatorGenerator::OperatorGenerator(Template* in_template) {
...
void OperatorGenerator::fillGrid(int S, int Sz, int sampleCount, int Nfactor, MatrixXf X, MatrixXf Y, VectorXf V,vector<MatrixXf> &G, vector<MatrixXi> &mask, vector<MatrixXi> &Gs){
...
void OperatorGenerator::print(MatrixXf matrix) {
    LOG(matrix);
}

void OperatorGenerator::print(MatrixXi matrix) {
    LOG(matrix);
}
